...
fcCore - это вспомогательная библиотека, которая предоставляет простой API для получения русских переводов названий предметов Minecraft. Поддерживает все 933 предмет версии 1.16.5.
